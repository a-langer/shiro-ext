...
public class CacheControl {
     ...
     * can be also used, in case resources shouldn't be cached
     * ({@link #cachePrivate()})
     ...
     * @return {@code this}, to facilitate method chaining
     * @see #maxAge(Duration)
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.8">rfc7234
     *      section 5.2.2.8</a>
     */
     ...
     * the {@link #noStore()} directive should be used instead of
     * {@code #noCache()}.
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.2">rfc7234
     *      section 5.2.2.2</a>
     */
     ...
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.3">rfc7234
     *      section 5.2.2.3</a>
     */
     ...
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.1">rfc7234
     *      section 5.2.2.1</a>
     */
     ...
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.4">rfc7234
     *      section 5.2.2.4</a>
     */
     ...
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.5">rfc7234
     *      section 5.2.2.5</a>
     */
     ...
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.6">rfc7234
     *      section 5.2.2.6</a>
     */
     ...
     * except that it does not apply to private caches (i.e. browsers, HTTP
     * clients).
     * 
     * @return {@code this}, to facilitate method chaining
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.7">rfc7234
     *      section 5.2.2.7</a>
     */
     ...
     * @see <a href="https://tools.ietf.org/html/rfc7234#section-5.2.2.9">rfc7234
     *      section 5.2.2.9</a>
     */
     ...
     *            the maximum time the response should be used while being
     *            revalidated
     * @param unit
     *            the time unit of the {@code staleWhileRevalidate} argument
     * @return {@code this}, to facilitate method chaining
     * @see #staleWhileRevalidate(Duration)
     * @see <a href="https://tools.ietf.org/html/rfc5861#section-3">rfc5861 section
     *      3</a>
     */
     ...
     * <p>
     * This directive indicates that when an error is encountered, a cached stale
     * response
     * MAY be used to satisfy the request, regardless of other freshness
     * information.
     * 
     * @param staleIfError
     *            the maximum time the response should be used when errors are
     *            encountered
     * @param unit
     *            the time unit of the {@code staleIfError} argument
     * @return {@code this}, to facilitate method chaining
     * @see #staleIfError(Duration)
     * @see <a href="https://tools.ietf.org/html/rfc5861#section-4">rfc5861 section
     *      4</a>
     */
