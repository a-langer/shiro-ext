...
public final class ContentDisposition {
    ...
    private static final Pattern BASE64_ENCODED_PATTERN = Pattern
            .compile("=\\?([0-9a-zA-Z-_]+)\\?B\\?([+/0-9a-zA-Z]+=*)\\?=");
    ...
    /**
     * Return the value of the {@literal size} parameter, or {@code null} if not
     * defined.
     * 
     * @deprecated since 5.2.3 as per
     *             <a href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC
     *             6266, Appendix B</a>,
    ...
    /**
     * Return the value of the {@literal creation-date} parameter, or {@code null}
     * if not defined.
     * 
     * @deprecated since 5.2.3 as per
     *             <a href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC
    ...
    /**
     * Return the value of the {@literal read-date} parameter, or {@code null} if
     * not defined.
     * 
     * @deprecated since 5.2.3 as per
     *             <a href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC
    ...
    /**
     * Return a builder for a {@code ContentDisposition} of type
     * {@literal "attachment"}.
     * 
     * @since 5.3
     */
    ...
    public interface Builder {
         ...
         * <a href="https://tools.ietf.org/html/rfc7578#section-4.2">RFC 7578, Section
         * 4.2</a>
