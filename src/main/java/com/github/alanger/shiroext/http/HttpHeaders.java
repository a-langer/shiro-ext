...
public class HttpHeaders implements MultiValueMap<String, String>, Serializable {
     ...
     * 
     * @since 5.3.6
     * @see <a href="https://tools.ietf.org/html/rfc5789#section-3.1">Section 3.1 of
     *      RFC 5789</a>
     */
     ...
     *             {@code password} contain characters that cannot be encoded to
     *             ISO-8859-1
     * @since 5.1
     ...
     * @throws IllegalArgumentException
     *             if supplied credentials string is
     *             {@code null} or blank
     * @since 5.2
     * @see #setBasicAuth(String, String)
     * @see #setBasicAuth(String, String, Charset)
    ...
    /**
     * Parse the first header value for the given header name as a date,
     * return {@code null} if there is no value, or raise
     ...
     * necessary.
     * <p>
     * Also caches the parsed representations of the "Accept" and "Content-Type"
     * headers.
     * 
     * @param headers
     *            the headers to expose
     * @return a read-only variant of the headers, or the original headers as-is
     *         (in case it happens to be a read-only {@code HttpHeaders} instance
     *         already)
     * @since 5.3
     */
    public static HttpHeaders readOnlyHttpHeaders(MultiValueMap<String, String> headers) {
        return (headers instanceof HttpHeaders ? readOnlyHttpHeaders((HttpHeaders) headers)
