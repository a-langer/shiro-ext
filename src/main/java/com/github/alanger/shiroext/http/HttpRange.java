...
public abstract class HttpRange {
     ...
     * 
     * @param resource
     *            the {@code Resource} to select the region from
     ...
     * appropriate segment of the given {@code Resource} using HTTP Range
     * information.
     * 
     * @param ranges
     *            the list of ranges
     * @param resource
     *            the resource to select the regions from
     * @return the list of regions for the given resource
     * @throws IllegalArgumentException
     *             if the sum of all ranges exceeds the resource length
     * @since 4.3
     */
...
class ResourceRegion {
     ...
     *            a Resource
     * @param position
     *            the start position of the region in that resource
     * @param count
