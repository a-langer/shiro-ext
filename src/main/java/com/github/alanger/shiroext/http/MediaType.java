...
import com.github.alanger.shiroext.util.MimeType;
import com.github.alanger.shiroext.util.MimeTypeUtils;
...
public class MediaType extends MimeType {
     ...
     *             {@link #APPLICATION_NDJSON} as
     *             a replacement or any other line-delimited JSON format (e.g. JSON
     *             Lines,
     *             JSON Text Sequences).
     */
    @Deprecated
