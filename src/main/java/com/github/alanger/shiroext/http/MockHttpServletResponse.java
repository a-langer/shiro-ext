...
public class MockHttpServletResponse implements HttpServletResponse {
    ...
    private String defaultCharacterEncoding = "UTF-8"; // WebUtils.DEFAULT_CHARACTER_ENCODING;
     ...
     * through {@link HttpServletResponse} methods or through a charset parameter on
     * the
     * {@code Content-Type}.
     * 
     * @return the content as a {@code String}
     ...
     * As of Servlet 3.0, this method is also defined in
     * {@link HttpServletResponse}.
     * As of Spring 3.1, it returns a stringified value for Servlet 3.0
     * compatibility.
     ...
     * As of Servlet 3.0, this method is also defined in
     * {@link HttpServletResponse}.
     * As of Spring 3.1, it returns a List of stringified values for Servlet 3.0
     * compatibility.
