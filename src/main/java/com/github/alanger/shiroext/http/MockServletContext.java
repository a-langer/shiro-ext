...
import com.github.alanger.shiroext.io.DefaultResourceLoader;
import com.github.alanger.shiroext.io.Resource;
import com.github.alanger.shiroext.io.ResourceLoader;
import com.github.alanger.shiroext.util.Assert;
import com.github.alanger.shiroext.util.ClassUtils;
...
public class MockServletContext implements ServletContext {
    ...
    public MockServletContext(String resourceBasePath, ResourceLoader resourceLoader) {
        ...
        if (tempDir != null) {
            this.attributes.put(/* WebUtils.TEMP_DIR_CONTEXT_ATTRIBUTE */ TEMPDIR, new File(tempDir));
        }
