...
public abstract class Assert {
     ...
     *            the exception message to use if the assertion fails
     * @throws IllegalArgumentException
     *             if the collection is {@code null} or
     ...
     *            exception message
     *            will be appended. If it ends in a space, the name of the offending
     *            object's
     *            type will be appended. In any other case, a ":" with a space and
     *            the name
     ...
     * @param messageSupplier
     *            a supplier for the exception message to use if the
     *            assertion fails. See {@link #isInstanceOf(Class, Object, String)}
     *            for details.
     * @throws IllegalArgumentException
     *             if the object is not an instance of type
     * @since 5.0
     ...
     *            will be appended. If it ends in a space, the name of the offending
     *            sub type
     *            will be appended. In any other case, a ":" with a space and the
     *            name of the
     ...
     * @param messageSupplier
     *            a supplier for the exception message to use if the
     *            assertion fails. See {@link #isAssignable(Class, Class, String)}
     *            for details.
     * @throws IllegalArgumentException
     *             if the classes are not assignable
     * @since 5.0
