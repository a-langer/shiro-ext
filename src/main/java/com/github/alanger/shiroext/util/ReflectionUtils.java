...
public abstract class ReflectionUtils {
    ...
    /**
     * Pre-built {@link MethodFilter} that matches all non-bridge non-synthetic
     * methods
     ...
     * superclasses.
     * Leaf class methods are included first and while traversing the superclass
     * hierarchy
     * any methods found with signatures matching a method already included are
     * filtered out.
     * 
     * @param leafClass
     *            the class to introspect
    ...
    public interface MethodFilter {
         ...
         * 
         * @param next
         *            the next {@code MethodFilter}
         * @return a composite {@code MethodFilter}
         * @throws IllegalArgumentException
         *             if the MethodFilter argument is {@code null}
         * @since 5.3.2
         */
    ...
    public interface FieldFilter {
         ...
         * 
         * @param next
         *            the next {@code FieldFilter}
         * @return a composite {@code FieldFilter}
         * @throws IllegalArgumentException
         *             if the FieldFilter argument is {@code null}
         * @since 5.3.2
         */
