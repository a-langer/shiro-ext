...
public abstract class StringUtils {
     ...
     * 
     * @param str
     *            the candidate object (possibly a {@code String})
     * @since 3.2.1
     ...
     *            {@code toString()} format ("en", "en_UK", etc), also accepting
     *            spaces as
     *            separators (as an alternative to underscores), or BCP 47 (e.g.
     *            "en-UK")
     ...
     *             {@link LinkedHashSet}
     *             (with every entry included at most once, even entries within the
     *             first array)
     */
    @Deprecated
     ...
     * 
     * @param coll
     *            the {@code Collection} to convert (potentially {@code null} or
     *            empty)
     * @param delim
