...
/**
 * Replaces original org.apache.shiro.web.util.RedirectView
 */
public class RedirectView {
     ...
     *            the encoding scheme for this view. Default is UTF-8.
     */
     ...
     *             if there is a problem issuing the redirect
     * @see #appendQueryProperties
     * @see #sendRedirect
     */
    public final void renderMergedOutputModel(Map<?, ?> model, HttpServletRequest request, HttpServletResponse response)
            throws IOException {
    ...
    protected void appendQueryProperties(StringBuilder targetUrl, Map<?, ?> model, String encodingScheme)
        ...
        if (queryProps != null) {
            for (Object o : queryProps.entrySet()) {
                ...
                String encodedValue = (entry.getValue() != null ? urlEncode(entry.getValue().toString(), encodingScheme)
                        : "");
     ...
     *
     * @param model
     *            the model elements for which to determine name-value pairs.
    ...
    protected void sendRedirect(HttpServletRequest request, HttpServletResponse response, String targetUrl,
        ...
        if (http10Compatible && !ignoreHttp10Compatible) {
